...
namespace TelaWEB.Controllers
{
    ...
    {
        // GET: Pessoa
        BDTCCEntities2 bd = new BDTCCEntities2();
        ...
        [HttpPost]
        public ActionResult CadPessoaFisica(string email, string senha, string nome, string telefone, string tipoPessoa, string cpf, string sexo, DateTime dataNascimento, string NumeroCasa, string cep, string bairro, string rua, string cidade, string estado)
        {
            Pessoa p = new Pessoa();
            ...
            return RedirectToAction("Pessoa", "CadPessoaFisica");
        }

        [HttpPost]
        public ActionResult cadEndereco(int idPessoa, string cep, string bairro, string rua, string estado, string cidade)
        {
        ...
        [HttpPost]
        public ActionResult CadastroPessoaFisica(int idPessoa, string cpf, string sexo, DateTime dataNascimento, string NumeroCasa)
        {
        ...
        public ActionResult LoginPessoa(string email, string senha)
        {
            ...
            foreach (var item in bd.Pessoa.ToList())
            {
                ...
                else if ((item.email == email) && (item.senha == senha) && (item.tipoPessoa == "J"))
                {
                    ...
                    p = item;
                    Session["LoginAcesso"] = p;
                    return RedirectToAction("DashbordJuridica", "Home");
